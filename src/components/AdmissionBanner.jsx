// // src/components/AdmissionBanner.jsx
// import React, { useState, useEffect } from 'react';
// import { motion, AnimatePresence } from 'framer-motion';
// import admissionImg from '../assets/admission14.png'; // your “Admission Open” image
...
//         >
//           <motion.div
//             className="bg-white rounded-lg overflow-hidden shadow-xl max-w-sm w-full mx-4"
//             initial={{ scale: 0.8 }}
//             animate={{ scale: 1 }}
...
//                 className="px-5 py-2 bg-[#1F386B] text-white rounded-full hover:bg-opacity-90 transition"
//               >
//                 Got it!
//               </button>
//             </div>
