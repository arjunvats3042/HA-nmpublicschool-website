...
//         {item}
//         {children && (
//           <span className="ml-2">{isMobile ? (isActive ? "▼" : "▶") : "▼"}</span>
//         )}
//       </motion.p>
...
//         {title: "Curriculam Overview", path: "/academics/curriculam"},
...
const Header = () => {
  ...
  // Close any open dropdowns and the mobile menu on route change
  useEffect(() => {
    setActive(null);
    setMenuOpen(false);
  }, [location]);
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        { title: "School Building", path: "/infrastructure/building" },
        { title: "Digital Classrooms", path: "/infrastructure/digital-classrooms" },
        { title: "Laboratories", path: "/infrastructure/laboratories" },
        { title: "Games & Sports", path: "/infrastructure/games-sports" },
      ],
    },
